...
function redireccionarEditar() {
  var id = localStorage.getItem('ofertaSeleccionada');
  if (id) {
    window.location.href = "/admin/oferta/editar?id=".concat(id);
  } else {
    Swal.fire({
      icon: 'warning',
...
function eliminarOferta() {
  return _eliminarOferta.apply(this, arguments);
}
function _eliminarOferta() {
  _eliminarOferta = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var id;
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    urlLogic = sessionStorage.getItem("urlLogic") + "/ofertas/desactivar";
                    if (!id) {
                      _context.next = 9;
                      break;
                    }
