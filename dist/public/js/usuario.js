...
function eliminarUsuario() {
  return _eliminarUsuario.apply(this, arguments);
}
function _eliminarUsuario() {
  _eliminarUsuario = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var id;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          id = localStorage.getItem('usuarioSeleccionado');
          Swal.fire({
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    urlLogic = sessionStorage.getItem("urlLogic") + "/usuarios/desactivar";
                    if (!id) {
                      _context.next = 9;
                      break;
                    }
