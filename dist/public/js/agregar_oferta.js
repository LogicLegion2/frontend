...
document.getElementById("agregarOferta").addEventListener("click", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var urlProductos, _yield$Promise$all, _yield$Promise$all2, responseProductos, productosData, productosSelect1, productosSelect2, producto1, producto2, descripcion, precio, foto, datosOferta, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 2;
          _context.next = 5;
          return Promise.all([fetch(urlProductos)]);
        case 5:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 1);
          responseProductos = _yield$Promise$all2[0];
        ...
        case 11:
          ...
          foto = document.getElementById("fotoOferta").value; // Objeto con los datos de la oferta a crear
          datosOferta = {
            producto1: producto1,
            producto2: producto2,
          ...
          _context.prev = 21;
          _context.next = 24;
          return fetch('http://localhost:3000/ofertas/crear', {
            method: 'POST',
            headers: {
        ...
        case 33:
          ...
          console.error("Fetch error:", _context.t0); // Manejo de errores si falla la petición fetch
        case 36:
          _context.next = 41;
          break;
        case 38:
          ...
          console.error("Fetch error:", _context.t1); // Manejo de errores si falla alguna de las peticiones fetch inicialmente
        case 41:
        case "end":
          return _context.stop();
      }
    }, _callee, null, [[2, 38], [21, 33]]);
  }));
  return function (_x) {
