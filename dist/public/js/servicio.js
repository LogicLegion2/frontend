...
function redireccionarEditar() {
  var id = localStorage.getItem('servicioSeleccionado');
  if (id) {
    window.location.href = "/admin/servicio/editar?id=".concat(id);
  } else {
    Swal.fire({
      icon: 'warning',
...
function eliminarServicio() {
  return _eliminarServicio.apply(this, arguments);
}
function _eliminarServicio() {
  _eliminarServicio = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var id;
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    urlLogic = sessionStorage.getItem("urlLogic") + "/servicios/desactivar";
                    if (!id) {
                      _context.next = 9;
                      break;
                    }
